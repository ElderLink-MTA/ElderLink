                                ...
                                <form method="post" action="">
                                    <div class="row gx-3 mb-4">
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="inputFirstName" disabled
                                                name="inputFirstName" type="text" placeholder="הכנס את שמך הפרטי"
                                                value="<?php echo htmlspecialchars($user['first_name']); ?>">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="small mb-1" for="inputLastName">שם משפחה</label>
                                            <input class="form-control" id="inputLastName" disabled name="inputLastName"
                                                type="text" placeholder="הכנס את שם המשפחה שלך"
                                    ...
                                    <div class="row gx-3 mb-4">
                                        <div class="col-md-6">
                                            <label class="small mb-1" for="inputEmailAddress">כתובת דואר
                                                אלקטרוני</label>
                                            <input class="form-control" disabled id="inputEmailAddress"
                                    ...
                                    <div class="mb-0 mt-3">
                                        ...
                                        <select name="inputSubject" id="inputSubject" style="width: 20%;">
                                            <option value="תמיכה טכנית">תמיכה טכנית</option>
                                            <option value="בעיה אישית עם מבוגר">בעיה אישית עם מבוגר</option>
