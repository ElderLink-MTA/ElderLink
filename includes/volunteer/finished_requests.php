          ...
          <div class="col-xl-9">
            <div class=" W-100">
              <div>
                ...
                // Fetch requests for the current user that have passed
                $sql = "
                SELECT r.*, 
                ...
                ORDER BY r.date DESC, r.end_time DESC;
                ";
                $stmt = $conn->prepare($sql);
            ...
            align-items: center;">
                                        <img src="../../images/old-woman.png" alt="old-woman" width="350" height="350">
                                    </div>
                                    <h4 style="text-align:center; font-weight: bold; ">נראה שאין כאן כלום... עדיין!</h4>
                                    <p style="text-align:center;">ברגע שבקשה פעילה ששובצתם אליה תסתיים, היא תועבר לכאן.</p>
                                </div>';
                                  } else {
