        ...
        <div class="container">
            ...
            <div class="container-xl px-4 mt-2">
                <nav class="nav nav-borders">
                    ...
                    <a class="nav-link" href="settings_preferences.php">העדפות מתנדב</a></nav>
                <hr class="mt-0 mb-4">
                <div class="row">
                                ...
                                <form method="post" action="update_profile.php" enctype="multipart/form-data">
                                    <div class="row gx-3 mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="inputFirstName" name="first_name" maxlength="30 type="text" placeholder="הכנס את שמך הפרטי" value="<?php echo htmlspecialchars($user['first_name']); ?>">
                                        </div>
                                        <!-- קבוצת טופס (שם משפחה) -->
                                        <div class="col-md-6">
                                            <label class="small mb-1" for="inputLastName">שם משפחה</label>
                                            <input class="form-control" id="inputLastName" name="last_name" type="text" maxlength="30" placeholder="הכנס את שם המשפחה שלך" value="<?php echo htmlspecialchars($user['last_name']); ?>">
                                        </div>
                                    </div>
                                       <div class="row gx-3 mb-3">
                                        <!-- קבוצת טופס (שם פרטי) -->
                                        <div class="col-md-5">
                                            ...
                                            <input class="form-control" id="inputCity" list="cities-data" name="city" maxlength="30" type="text" placeholder="הכנס את עיר מגוריך" value="<?php echo htmlspecialchars($user['city']); ?>">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <input class="form-control" id="inputAddress" name="address" type="text" maxlength="30" pattern="[\u0590-\u05FF\s]+" placeholder="הכנס את הרחוב שלך" value="<?php echo htmlspecialchars($user['address']); ?>">
                                        </div>
                                        <!-- קבוצת טופס (מספר רחוב) -->
                                        <div class="col-md-2">
                                            <label class="small mb-1" for="inputAddressNum">מספר רחוב</label>
                                            <input class="form-control" id="inputAddressNum" name="address_num" type="text" maxlength="3" pattern="[0-9]*" placeholder="הכנס את מספר הרחוב" value="<?php echo htmlspecialchars($user['address_num']); ?>">
                                        </div>
                                    </div>
                                    <!-- קבוצת טופס (כתובת דואר אלקטרוני) -->
                                    <div class="mb-3">
                                        <label class="small mb-1" for="inputEmailAddress">כתובת דואר אלקטרוני</label>
                                        <input class="form-control" id="inputEmailAddress" disabled name="email" type="email" placeholder="הכנס את כתובת הדואר האלקטרוני שלך" value="<?php echo htmlspecialchars($user['email']); ?>">
                                    </div>
                                    <!-- שורת טופס -->
                                    <div class="row gx-3 mb-3 ">
                                        <!-- קבוצת טופס (מספר טלפון) -->
                                        <div class="col-md-6">
                                            <label class="small mb-1" for="inputPhone">מספר טלפון</label>
                                            <input class="form-control" id="validationTooltiPhone" name="phone" type="tel" minlength="9" maxlength="12" placeholder="הכנס את מספר הטלפון שלך" value="<?php echo htmlspecialchars($user['phone']); ?>">
                                        </div>
                                        <!-- קבוצת טופס (יום הולדת) -->
                                        <div class="col-md-6">
                                            <label class="small mb-1" for="inputBirthday">תאריך לידה</label>
                                            <input class="form-control" id="dateOfBirth" type="date" name="date_of_birth" value="<?php echo htmlspecialchars($user['date_of_birth']); ?>">
                                        </div>
                                        ...
                                        <div class="mb-0 mt-3">
                                            ...
                                            <select name="languages[]" id="field2" multiple style="width: 285px;">
                                                <option value="עברית" <?php if (in_array("עברית", $user_languages)) echo 'selected'; ?>>עברית</option>
                                                <option value="אנגלית" <?php if (in_array("אנגלית", $user_languages)) echo 'selected'; ?>>English</option>
                                                <option value="רוסית" <?php if (in_array("רוסית", $user_languages)) echo 'selected'; ?>>Pусский</option>
                                                <option value="ערבית" <?php if (in_array("ערבית", $user_languages)) echo 'selected'; ?>>العربية</option>
                                                <option value="צרפתית" <?php if (in_array("צרפתית", $user_languages)) echo 'selected'; ?>>Français</option>
                                                <option value="ספרדית" <?php if (in_array("ספרדית", $user_languages)) echo 'selected'; ?>>Español</option>
                                            </select>
                                        </div>
                                        </div>
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card mb-4 mb-xl-0">
                            ...
                            <div class="card-body text-center">
                                <!-- תמונת פרופיל -->
                                <img class="img-account-profile rounded-circle mb-2" src="<?php echo $profile_image_url; ?>" alt="Profile Picture" id="profileImage">     <!-- קבוצת עזרה לתמונת פרופיל -->
                                <div class="small font-italic text-muted mb-4" style="text-align: center;">JPG או PNG בלבד, עד 5 מגה-בייט</div>
                                <!-- כפתור העלאת תמונה חדשה לפרופיל -->
                                <input class="form-control" id="inputProfilePicture" name="picture" type="file" accept="image/jpeg, image/png">
