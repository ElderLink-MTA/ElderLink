														...
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div class="fullWidth" style="max-width: 116px;"><img src="https://66c61864f3.imgdist.com/pub/bfra/1wftxzp5/miu/jrn/hgk/cancelled.png" style="display: block; height: auto; border: 0; width: 100%;" width="116" alt="Confirm subscription" title="Confirm subscription" height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
													<table class="paragraph_block block-3" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-right:60px;padding-top:20px;">
																...
																<p style="color: #0047ab;"><strong>שלום $first_name,&nbsp;</strong></p>
																<p style="margin: 0;">בקשה מספר $req_id ששלחת באתר ElderLink בוטלה, וחזרה כעת לבקשות ממתינות לשיבוץ.</p>														

																<p style="margin: 0;"><strong>אנו מאחלים לך יום מהנה ונעים, מצוות אתר ElderLink.</strong></p>														
																</div>
															</td>
														</tr>
													</table>
