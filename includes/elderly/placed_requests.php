...
<body>
  ...
  <main class="d-flex flex-nowrap">
    ...
    <div class="container">
      <div class="container-xl px-4 mt-2">
        <nav class="nav nav-borders">
          ...
          <a class="nav-link" href="waiting_requests.php"> <span class="wait-request-indicator"></span>
        ...
        <div class="row">
          <div class="col-xl-9">
                ...
                <div class="list-group pt-3 gap-2">
                  ...
                  <a href="#" class="list-group-item list-group-item-action d-flex W p-2" aria-current="true">
                    ...
                    <div class="d-flex w-100 justify-content-between">
                      ...
                      <div class="col-md-1 text-center" style="width: 200;">
                        <button class="btn btn-sm btn-danger"
                          onclick="confirmCancel(<?php echo $request['req_id']; ?>)">ביטול</button>
            ...
            align-items: center;">
                                    ...
                                    <h4 style="text-align:center; font-weight: bold; ">עדיין לא אישרו לכם את הבקשה?</h4>
                                    <p style="text-align:center;">עדיין אין לכם בקשות פעילות. אבל אל דאגה, ברגע שיאשרו בקשה שלכם, היא תועבר לכאן.</p>
                            </div>';
                  }
                  ?>
                </div>
    ...
    <script src="../../js/placed_requests.js"></script>
