													...
													<table class="paragraph_block block-3" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-right:60px;padding-top:20px;">
																...
																<p style="color: #0047ab;"><strong>שלום $volunteer_first_name,&nbsp;</strong></p>
																<p style="margin: 0;">בקשה מספר $req_id שאישרת באתר ElderLink בוטלה על ידי המבוגר/ת.</p>														
